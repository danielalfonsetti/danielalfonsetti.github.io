                                ...
                                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div className="col-md-12">
                                        <div className="about-desc">
                                            ...
                                            <p> Autonomous Vehicles, Computational Biology, Quantitative Finance </p>
                                            <h2 className="colorlib-heading">Hobbies</h2>
                                            <p> I enjoy studying personal finance and staying active. I also enjoy staying up to date with trending technologies. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
